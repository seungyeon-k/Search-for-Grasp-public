...
class PyBulletRecorder:
    class LinkTracker:
        def __init__(self,
            ...
            self.mesh_color = mesh_color # color is added
    ...
    def register_object(self, body_id, urdf_path, global_scaling=1, global_color=None):
        link_id_map = dict()
            ...
            if len(link.visuals) > 0:
                for i, link_visual in enumerate(link.visuals):
                    ...
                    if global_color is not None:
                        mesh_color = global_color
                    else:
                        if link_visual.material is not None:
                            mesh_color = link_visual.material.color
                        else:
                            mesh_color = None
    ...
    def get_formatted_output(self):
        ...
        for link in self.links:
            retval[link.name] = {
                ...
                'mesh_color': link.mesh_color, # color is added
